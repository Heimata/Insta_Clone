...
<div class="container">
    ...
    <div class="row pt-5">
        <div class="col-4">
            <img src="https://picsum.photos/id/237/200/300" class="w-100 h-100">
        </div>
        <div class="col-4">
            <img src="https://picsum.photos/200/300?grayscale" class="w-100 h-100">
        </div>
        <div class="col-4">
            <img src="https://picsum.photos/200/300/?blur" class="w-100 h-100">
        </div>
    </div>
</div>
@endsection
